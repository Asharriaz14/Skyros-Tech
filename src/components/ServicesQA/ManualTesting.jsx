...
import { manualTesting } from "../../constants"
...
function ManualTesting() {
    return (
        ...
        <div className="flex flex-wrap mt-10 lg:mt-4">
          {manualTesting.map((manualTest, index) => (
            <div className="max-w-sm p-6 bg-white border my-2 md:mx-4 border-gray-200 rounded-lg shadow" key={index}>
              <div className="flex items-center mb-3">
                  <h5 className="mb-0  text-2xl font-semibold tracking-tight text-gray-900">{manualTest.title}</h5>
              </div>
              <p className="mb-3 text-gray-500">{manualTest.description}</p>
