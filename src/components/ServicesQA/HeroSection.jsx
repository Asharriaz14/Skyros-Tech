...
const HeroSection = () => {
  ...
  return (
    ...
    <stop offset="1" stopColor="white" stopOpacity="0.08" />
      ...
      Our expert manual testing teams meticulously evaluate your software applications to identify defects, inconsistencies, and usability issues. Through a combination of rigorous testing methodologies and real-world scenarios, we ensure that your software performs seamlessly across various platforms and devices.
      </motion.p>
    ...
    className="animate-bounce focus:animate-none hover:animate-none text-center items-center text-md font-medium bg-[#4A6CF7] py-4  px-5 mt-3  rounded-lg tracking-wide text-white">
