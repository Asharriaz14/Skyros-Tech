...
const HeroSection = () => {
  ...
  return (
    ...
    <stop offset="1" stopColor="white" stopOpacity="0.08" />
      ...
      SKYROS is a leading provider of comprehensive healthcare integration solutions designed to streamline data exchange and interoperability across various healthcare systems and platforms. With extensive expertise in EMR (Electronic Medical Record) integration, we enable seamless communication and data sharing between disparate healthcare systems, improving efficiency, accuracy, and patient care outcomes.
      </motion.p>
